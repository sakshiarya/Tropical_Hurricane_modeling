#################### Hierarchical NS EVD ##########################################################################
# This code is for fitting a hierarchical non-stationary EVD model with variables maxWS, minCP as 
# univariate EVD models and damages as log-normal for years 1960-2015.
...
tri_var2015$x2 <- tri_var2015$CURRENT.DAMAGE.2021
...
m_x1$results$par
m_x2 <- lm(log(x2) ~ scalex1 + scalez1 + z2, data = tri_var2015)
m_x2$coefficients
...
save(results, file = "hierNS_HFNDamages_1e6_27August_1960to2015.RData")
...
load("hierNS_HFNDamages_1e6_27August_1960to2015.RData")
